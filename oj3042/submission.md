...
```text
รับค่าจำนวนเต็มบวก 1 จำนวน และหาว่าจำนวนเต็มบวกตั้งแต่ N ถึง 0 มีตัวเลขใดบ้างที่หารด้วย 10 ลงตัว
input
จำนวนเต็มบวก N
output
...
```text
คิดว่าข้อนี้ควรใช้ลูปน่าจะง่าย และใช้ if ในลูป เพื่อตรวจสอบเงื่อนไข โดยใช้ % เพื่อหาว่า หาร 10 ลงตัว จะ = 0
และเพิ่มค่าเข้าไปใน list
```
...
```text
เหมือนเดิม เพราะข้อนี้ไม่มีอะไรซับซ้อน
```
...
```text
ลองเลข 3 หลัก ที่ไม่ลงท้ายด้วย 0
```
...
```text
ลองเลข 2 หลัก ที่ไม่ลงท้ายด้วย 0
```

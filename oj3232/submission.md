...
```text
โจทย์ต้องการให้เราคำนวณว่า x จะไปถึง y ในการกระโดดกี่ครั้ง โดยเริ่มที่ 0 และ x จะ ถูกลบไปทีละ 2 ทำให้ต้องคำนวณว่าจะไปถึง y ต้องใช้กี่ครั้ง หรือถ้าไม่ถึงก็ตอบ -1
input - x, y บรรทัดเดียวกัน
output - จำนวนการกระโดด
```
...
```text
จะรับค่าโดยที่ใช้ .split เพื่อใส่ list จากนั้นก็กำหนด ค่ากระโดดเป็น 0 และรอบของการกระโดดเป็น 0 และ ใช้ while loop เพื่อหาว่ารอบของกระโดดเป็นเท่าไหร่ และเพิ่มค่าไปเรื่อยๆ และ x-2 ไปเรื่อยๆ จน x <= 0 จึง break loop และ print รอบของการกระโดดออกมา
```
...
```text
ใช้แบบวิธีแรก เพราะเป็นวิธีที่ป้อนค่าจนกว่า x จะเป็น 0 หรือน้อยกว่า เพื่อนับค่าการกระโดด  
```
...
```text
ระยะกระโดดครั้งแรกเป็น 0 หรือติดลบตั้งแต่เริ่มต้น
```

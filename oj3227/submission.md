...
```text
โจทย์ต้องการรับ input เป็น ตัวอักษรย่อหรือตัวเลข และ output ออกมาเป็นชื่อเต็มๆ คั่นด้วย of
```
...
```text
ด้วยความที่ตัวแรกต้องเป็น A,2,3,...,J,Q,K และตัวหลังเป็น clubs จึงใช้ dictionary เพื่อง่ายต่อการทำ และ print โดยการ คั่น ด้วย of
```
...
```text
ใช้แบบวิธีเดิมเพราะเป็นวิธีที่ง่าย เพราะใช้ dictionary ทำให้การเรียกใช้งานง่าย จากนั้นก็ทบสอบ
```

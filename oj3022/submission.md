...
```text
โจทย์ข้อนี้ ต้องการแปลงหน่วยของอุณหภูมิ ตามที่ต้องการ โดย
input - รับ 3 บรรทัดคือ ค่าอุณหภูมิ เป็นจำนวนจริง, อักษร C, F, K, R, เป็นอักษร C, F, K, R เป็นหน่วยของอุหณภูมิที่ต้องการ
output - เป็นจำนวนจริง เป็นอุณหภูมิ ตามหน่วยในบรรทัดที่ 3 ใน Input Spec ให้ตอบทศนิยม 2 ตำแหน่ง
```
...
```text
ต้องการแปลง ทุกอุณหภูมิที่รับมา แปลงเป็น celsius ก่อน และนำไปเข้าสูตร
```
...
```text
เหมือนแผนแรก เพราะเป็นไปตามที่วางแผนไว้
```

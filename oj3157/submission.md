...
```text
input ต้องการรับ n เป็นจำนวนเต็ม ที่มีค่าตั้งแต่1ขึ้นไป และ loop ตามจำนวน n เพื่อรับค่า + และ -
output ต้องการค่าที่คำนวณแล้วออกมา
```
...
```text
แผนคือ รับ input เป็น n จากนั้นใช้ for loop ตามจำนวน n เพื่อรับคำสั่ง op เช่น + หรือ - และทำการตรวจสอบเงื่อนไข ของ op ถ้า เป็น "+" ต้อง เพิ่มค่า total 10 แต่หากเป็น "-" ต้องลบค่าไป 5 จากนั้นก็แสดง output
```
...
```text
ใช้วิธีเดิมเพราะ เป็นวิธีที่ง่ายและเข้าใจง่าย
```

...
```text
ข้อนี้ไม่มีอะไรซับซ้อน โจทย์ต้องการว่ามีจํานวนนับ x ในช่วง [A , B] กี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
input
...
```text
รับ input ก่อน 4 บรรทัด หลังจากนั้น สร้างตัวแปร มาเพื่อรอเก็บค่า และใช้ลูปในการตรวจสอบเงื่อนไข พอได้ก็นำไปเพิ่มในตัวแปรที่สร้าง และ print ออกมา
```
...
```text
เหมือนที่วางแผนไว้ เพราะไม่มีอะไรซับซ้อน
```

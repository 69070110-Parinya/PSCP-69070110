...
```text
โจทย์ต้องการหาว่า เมื่อวินาทีที่เท่าไหร่บ้านของเขาจะถูกน้ำท่วม และปัดเศษขึ้นทั้งหมด  โดยที่น้ำหมึกจะขยายตัว S ตารางหน่วย ต่อวินาที เป็นวงกลม
input - จำนวนเต็มแทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาทีและจำนวนเต็มแทนจำนวนคำร้องจากผู้คน
จากนั้นบรรทัดต่อมา แทน ตำแหน่ง x, y ของคำร้องของผู้คน ตามจำนวนของบรรทัดที่แล้ว
output - ระบุจำนวนเต็มหนึ่งตัว ตอบคำถามของคนที่ i ว่าบ้านของเขาจะถูกน้ำท่วมในวินาทีที่เท่าใด
```
...
```text
คิดแผนโดยการ กำหนดค่า pi ตามโจทย์ และ import math เข้ามาเพื่อใช้ .ceil ในการปัดเศษขึ้นทุกกรณี จากนั้นรับ
input และใช้ for loop ตามจำนวนคำร้อง จากนั้นถึงการคำนวณ จะใช้ สมการวงกลม ในการมาหาคำตอบ รับ x, y มาแล้ว เหลือแค่ r ก็ทำการย้ายข้างหา r สุดท้ายหาเวลาโดยการ ใช้สูตรพื้นที่วงกลม คือ pi * r**2 หารด้วยพื้นที่ที่รับมาในตอนแรก ก็จะได้พื้นที่ที่ขยายใน 1 วินาทีแล้ว
```
...
```text
ใช้แผนเดิม เพราะเป็นวิธีหาที่คิดว่าดีที่สุด เนื่องจากการใช้สมการวงกลม และ สูตรพื้นที่วงกลมมาช่วยในการหาคำตอบ
```

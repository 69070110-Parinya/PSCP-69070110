...
```text
โจทย์ต้องการให้แสดงจำนวนอิฐก้อนเล็กที่ต้องใช้ โดย อิฐ a ก้อนเล็ก มีความยาว 1 นิ้ว อิฐ b ก้อนใหญ่จะมีความยาว 5 นิ้วใ ห้หาว่าเมื่อนำอิฐมาต่อกันสร้างเป็นสะพาน จะต้องใช้อิฐก้อนเล็กน้อยที่สุดกี่ก้อน
input
...
```text
จะหาก่อนว่าใช้อิฐใหญ่ เท่าที่ใช้ได้เท่าไหร่ ส่วนที่เหลือค่อยนำอิฐเล็กมาเพิ่ม โดยที่นำ goal มาลบกับ อิฐใหญ่ที่หาแล้วคูณ 5 หลังจากนั้น ใช้ if ตรวจสอบเงื่อนไข และ print เป็นอันจบ
```
...
```text
เหมือนเดิม เพราะข้อนี้อาจจะต้องคิดซับซ้อนหน่อย แต่ไม่ได้ผิดกับแผนที่วางเอาไว้
```
...
```text
เลือกที่ไม่ต้องใช้อิฐเล็กเลย หรือคือ = 0
```

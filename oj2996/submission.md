...
```text
โจทย์ต้องการให้แสดงผลข้อความตัวอักษรภาษาอังกฤษแบบกลับด้านเป็นตัวพิมพ์เล็ก
Input:
...
```text
ขั้นตอนแรก : อ่านว่าโจทย์ต้องการให้ทำอะไร
ขั้นต่อมา : วางแผนว่าควรทำยังไง
ขั้นต่อมา : ลงมือทำตามแผน
ขั้นสุดท้าย : ตรวจสอบผล
```
...
```text
ใช้ input รับค่า str เข้ามา และ print ด้วย .lower เพื่อให้ตัว str ที่รับมาทั้งหมดเป็นตัวเล็ก และใช้ Slicing เพื่อ Reverse ตามที่โจทย์ต้องการ
```
...
```text
มีตัวใหญ่ผสม เพื่อเช็คว่าตามที่โจทย์กำหนดไหม
```
...
```text
เป็นตัวใหญ่ทั้งหมด ต่างจากก่อนหน้ามีตัวใหญ่แค่ 1 ตัว
```
...
```text
เคสนี้ใกล้ เปลี่ยนเป็นตัวเล็กแต่ว่าไม่กลับด้าน
```

...
```text
โจทย์ต้องการตรวจรางวัล ว่าได้เงินรางวัลเท่าไหร่ มี 2 บรรทัด input - ข้อมูลเข้าบรรทัดแรก เป็นผลการออกรางวัลสลากกินแบ่ง ข้อมูลเข้าบรรทัดที่ 2 เป็นหมวดตัวอักษร และ หมายเลขสลากที่ซื้อ output - แสดงเงินรางวัลที่ได้รับ 
```
...
```text
ข้อนี้ใช้เพียง if else ในการตรวจสอบเงื่อนไขต่างๆ ใช้ list ในการรับ input แบบเว้นวรรค และนำค่ามาตรวจสอบเงื่อนไข
```
...
```text
ใช้แบบเดิมเพราะ เป็นวิธีที่ง่าย และเข้าใจง่าย เพียงแค่ใช้ if else ในการตรวจสอบเท่านั้น
```
...
```text
ถูกรางวัลใหญ่สุด (ตรงทั้งหมวดอักษรและหมายเลข)
```
...
```text
ถูกรางวัลเลขท้าย 2 ตัว แต่หมวดอักษรต่างกัน
```

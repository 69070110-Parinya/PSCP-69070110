...
```text
ข้อนี้เป็นการเช็ค season โดยการที่ input จะรับเป็น เดือน และตามด้วยวัน ตามลำดับ และ output เช็คว่าอยู่ที่ฤดูไหน
โดยที่ฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว
```
...
```text
ข้อนี้ต้องวางแผนดีๆเพราะมีจุดที่เป็นส่วนที่ยากเลยคือ โดยฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว
อันดับแรก เลือกใช้ if เพื่อใช้เป็นตัวกำหนดเงื่อนไขของเดือน
```
...
```text
มีไม่ตรงตามแผนบ้าง แต่ก็สามารถปรับแก้ได้ เพราะ กระบวนการคิดผิดลำดับ
```

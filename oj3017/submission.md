...
```text
โจทย์อยากรู้ราคาที่ลูกค้าต้องชำระ โดยที่ กำหนดค่าบริการไว้ 10% ของราคาอาหารและเครื่องดื่มที่ลูกค้าได้สั่งไปแต่ร้านนี้ได้มีข้อกำหนดว่าค่าบริการจะคิดอย่างน้อย 50 บาท และ ไม่เกิน 1000 บาท และยังมี vat7% ที่เป็นของค่าอาหาร
input
เฉพาะค่าอาหารและเครื่องดื่มที่ลูกค้าได้สั่งไป (จำนวนเต็ม)
output
ราคาที่ต้องจ่ายจริง
```
...
```text
ข้อนี้ผมตัดสินใจใช้ if เพราะคิดว่าเป็นการเลือกเงื่อนไขที่ตัวเองเข้าใจที่สุด โดยแบง่แยกเป็นกรณี ตามที่โจทย์ต้้องการ
เมื่อวางแผนแล้วก้ทำตามแผนที่วางไว้ และตรวจสอบผล
```
...
```text
เหมือนแผนแรกเพราะ ข้อนี้ทำแบบที่ตัวเองเข้าใจเลยคิดว่าไม่ยากมาก
```

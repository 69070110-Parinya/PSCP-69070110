...
```text
โจทย์ต้องการให้รับ input 2 ค่า คือ ต้นทาง และ ปลายทาง บรรทัดต่อมาต้องการ น้ำหนัก ซึ่งเป็นชนิด float
ให้เช็คคำนวณค่าธรรมเนียมการส่งพัสดุจะต้องเลือกต้นทาง - ปลายทาง และ น้ำหนักของพัสดุที่จะส่ง output ออกเป็น ราคาที่ต้องจ่าย หากไม่ตรงตามในตารางให้ print Error
```
...
```text
ใช้วิธีเช็คเงื่อนไขด้วย if elif จากโจทย์ที่เงื่อนไข 6 เงื่อนไข และทุกเงือนไข จะต้องบวกค่าธรรมเนียม ตามตาราง
อันดับแรก ใช้ .split เพื่อที่ใน 1 บรรทัดสามารถกรอกข้อมูลถัดไปได้ และรับ input อีกบรรทัดเป็นค่า float 
พอใช้ if elif เช็คเงื่อนไขเสร็จ ก็ print output ออกมา
```
...
```text
ใช้ตามวิธีก่อนหน้า เพราะเป็นวิธีที่ลองแล้วใช้ได้ผล
```
...
```text
เพราะลองเงื่อนไขที่เป็นจำนวนเต็ม
```
...
```text
เพราะเช็คเงื่อนไขที่เป็น Error
```
